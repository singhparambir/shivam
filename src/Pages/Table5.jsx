...
export default function CrudDataTablefive() {
  ...
  const handlePageChange = (page) => {
    navigate(`/page${page}`); // Navigate to the respective page
  };
      ...
      <div style={{ height: 600, width: "100%" }}>
        <DataGrid
          ...
          getRowClassName={(params) => {
            return params.row.id === "Total" ? "total-row" : ''; // Apply class if it's the total row
          }}
          sx={{
            "& .header-id": { backgroundColor: "#d9f5fc", color: "#000", fontSize: '28px', fontWeight: 'bold' },
            "& .header-brand": { backgroundColor: "#d9f5fc", color: "#000", fontSize: '28px', fontWeight: 'bold' },
            "& .header-ob": { backgroundColor: "#d9f5fc", color: "#000", fontSize: '28px', fontWeight: 'bold' },
            "& .header-prod": { backgroundColor: "#d9f5fc", color: "#000", fontSize: '28px', fontWeight: 'bold' },
            "& .header-desp": { backgroundColor: "#d9f5fc", color: "#000", fontSize: '28px', fontWeight: 'bold' },
            "& .header-cb": { backgroundColor: "#d9f5fc", color: "#000", fontSize: '28px', fontWeight: 'bold' },
            "& .header-actions": { backgroundColor: "#d9f5fc", color: "#000", fontSize: '28px', fontWeight: 'bold' },
            "& .total-row": {
      ...
      <Box display="flex" justifyContent="center" marginTop={2}>
        {[...Array(5).keys()].map((i) => (
          <Button
            ...
            color="primary"
            style={{ margin: "0 5px" }}
            onClick={() => handlePageChange(i + 1)} // Navigate to page
          >
            Page {i + 1}
          </Button>
        ))}
